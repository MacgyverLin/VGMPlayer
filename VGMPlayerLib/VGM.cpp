...
////////////////////////////////////////////////////////////////
VGMDataObverser::VGMDataObverser(VGMData& vgmData_)
	: vgmData(vgmData_)
{
}
...
VGMDataOpenALPlayer::~VGMDataOpenALPlayer()
{
}
...
void VGMDataOpenALPlayer::onNotifyOpen(Obserable& observable)
{
	VGMData& vgmData = (VGMData &)observable;
...
void VGMDataOpenALPlayer::onNotifyStop(Obserable& observable)
{
	VGMData& vgmData = (VGMData &)observable;
}

void VGMDataOpenALPlayer::onNotifyPause(Obserable& observable)
{
	VGMData& vgmData = (VGMData &)observable;
}

void VGMDataOpenALPlayer::onNotifyResume(Obserable& observable)
{
	VGMData& vgmData = (VGMData &)observable;
}

void VGMDataOpenALPlayer::onNotifyUpdate(Obserable& observable)
{
	VGMData& vgmData = (VGMData &)observable;
	const VGMData::PlayInfo& playInfo = vgmData.getPlayInfo();
	const VGMData::BufferInfo& bufferInfo = vgmData.getBufferInfo();
