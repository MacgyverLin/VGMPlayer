...
protected:
	...
	virtual INT32 seekSet(UINT32 size);
	virtual INT32 seekCur(UINT32 size);
	...
	virtual INT32 onRead(VOID *buffer, UINT32 size) = 0;
	virtual INT32 onSeekSet(UINT32 size) = 0;
	virtual INT32 onSeekCur(UINT32 size) = 0;
