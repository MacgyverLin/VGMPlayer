...
{
public:
	Vector2(FLOAT32 x_ = 0, FLOAT32 y_ = 0)
	{
		x = x_;
		y = y_;
	}
...
{
public:
	Rect(FLOAT32 x_ = 0, FLOAT32 y_ = 0, FLOAT32 w_ = 0, FLOAT32 h_ = 0)
	{
		x = x_;
		y = y_;
		w = w_;
...
public:
	...
	boolean Open(const string& name_, UINT32 x_, UINT32 y_, UINT32 width_, UINT32 height_);
	void Close();
	...
	void DrawWireCircle(const Vector2& center, FLOAT32 radius, const Color& c);
	...
	void DrawSolidCircle(const Vector2& center, FLOAT32 radius, const Color& c);

	void DrawPrimitive(UINT32 primitive, const Vector2* vertices, const Color* colors, UINT32 count);
	...
	void DrawTexPrimitive(const Texture2D& texture, UINT32 primitive, const Vector2* v, const Color* c, const Vector2* t, UINT32 count);
protected:
private:
	////////////////////////////////////////////////////////////////////////////
public:
