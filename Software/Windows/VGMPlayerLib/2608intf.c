...
void ym2608_update_request(void *param)
{
	...
	ym2608_update_one(info->chip, DUMMYBUF, 0, DUMMY_CHANNEL_BUF, 0);
	// Not necessary.
	//if (info->psg != NULL)
...
int device_start_ym2608(UINT8 ChipID, int clock, UINT8 AYDisable, UINT8 AYFlags, int* AYrate, UINT8 CHIP_SAMPLING_MODE, INT32 CHIP_SAMPLE_RATE, UINT32 SampleRate)
{
...
#ifdef ENABLE_ALL_CORES
		case EC_MAME:
			info->psg = ay8910_start_ym(NULL, CHTYPE_YM2608, ay_clock, &intf->ay8910_intf, CHIP_SAMPLING_MODE, CHIP_SAMPLE_RATE, SampleRate);
			break;
#endif
		case EC_EMU2149:
