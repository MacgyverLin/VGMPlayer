void daccontrol_update(UINT8 ChipID, UINT32 samples, UINT32 SampleRate);
UINT8 device_start_daccontrol(UINT8 ChipID, UINT8 CHIP_SAMPLING_MODE, INT32 CHIP_SAMPLE_RATE, UINT32 SampleRate);
