...
void y8950_stream_update(UINT8 ChipID, stream_sample_t **outputs, int samples, WAVE_32BS** channeloutputs, int channelcount)
{
	//y8950_state *info = (y8950_state *)param;
	y8950_state *info = &Y8950Data[ChipID];
	y8950_update_one(info->chip, outputs, samples, channeloutputs, channelcount);
}
...
static void _stream_update(void *param/*, int interval*/)
{
	...
	y8950_update_one(info->chip, DUMMYBUF, 0, DUMMY_CHANNEL_BUF, 0);
}


//static DEVICE_START( y8950 )
int device_start_y8950(UINT8 ChipID, int clock, UINT8 CHIP_SAMPLING_MODE, INT32 CHIP_SAMPLE_RATE, UINT32 SampleRate)
{
	...
	info->chip = y8950_init(clock,rate, CHIP_SAMPLING_MODE, CHIP_SAMPLE_RATE, SampleRate);
